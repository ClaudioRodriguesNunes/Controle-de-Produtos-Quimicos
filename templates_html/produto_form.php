...
<head>
  <meta charset="utf-8">
  <title>
    <?= $produto['id_produto'] ? 'Editar Produto' : 'Novo Produto' ?>
  </title>
  <link
...
<body class="p-4">
  ...
  <div class="container">
    ...
    <form
      action="ProdutoController.php?action=<?= $produto['id_produto'] ? 'edit&id=' . $produto['id_produto'] : 'new' ?>"
      method="post"
    >
      <div class="mb-3">
      ...
      <div class="mb-3">
        <label class="form-label">Validade (YYYY-MM-DD)</label>
        <input
          type="date"
